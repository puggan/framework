 ...
 * @method $this addNestedWhereQuery(QueryBuilder $query, string  $boolean)
 ...
 * @method $this getFresh(array $columns = ['*'])
 ...
 * @method $this leftJoinWhere(string $table, string $one, string $operator = null, string $two = null)
 ...
 * @method $this numericAggregate(string $function, $columns = ['*'])
 ...
 * @method $this orderByRaw(string $column, string $direction = 'asc')
 ...
 * @method $this union(QueryBuilder|\Closure $query, $all = false)
 * @method $this unionAll(QueryBuilder|\Closure $query)
